...
<div class="sfTMessageContainer sfTAlert"> 
  <img alt="page not found" class="sfTMessageIcon" width="48" height="48" src="${params.parameters.context}/images/icons/cancel48.png" />
  <div class="sfTMessageWrap">
    <h1>Oops! Page Not Found</h1>
    <h5>The server returned a <code>404 Page Not Found</code> response.</h5>
  </div>
</div>
